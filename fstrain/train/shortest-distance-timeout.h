...
//
// shortest-distance-timeout.h

// \file
// Copied from OpenFst 1.1, but with added timeout funcality.

#ifndef FSTRAIN_TRAIN_SHORTEST_DISTANCE_TIMEOUT_H__
#define FSTRAIN_TRAIN_SHORTEST_DISTANCE_TIMEOUT_H__
...
struct ShortestDistanceOptions {
  ...
  double delta;           // Determines the degree of convergence required
