...
#ifndef FSTRAIN_UTIL_MULTIPLIED_MAP_H_
#define FSTRAIN_UTIL_MULTIPLIED_MAP_H_
...
/**
 * @brief Function object that takes a pair and multiplies the second
 * element by a factor.
 */
...
/**
 * @brief A wrapper for std::map that lazily multiplies the map by a
 * constant factor.
 */
