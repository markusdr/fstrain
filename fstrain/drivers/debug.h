...
#ifndef FSTRAIN_DRIVERS_DBG_H
#define FSTRAIN_DRIVERS_DBG_H
...
#else
#define FSTR_DRIVERS_DBG_MSG(n,x)
#define FSTR_DRIVERS_DBG_EXEC(n,x)
#endif

#define FSTR_DRIVERS_ERROR(x){std::stringstream ss123; ss123 << "fstrain util error: " << x; std::cerr << __FILE__ << ":" << __LINE__ << ":" << ss123.str() << std::endl; exit(EXIT_FAILURE);}
